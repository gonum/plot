		...
		case vg.CurveComp:
			...
			case 1:
				fmt.Fprintf(buf, "Q%.*g,%.*g,%.*g,%.*g",
					pr, comp.Control[0].X.Dots(c.dpi), pr, comp.Control[0].Y.Dots(c.dpi),
					pr, comp.Pos.X.Dots(c.dpi), pr, comp.Pos.Y.Dots(c.dpi))
			case 2:
				fmt.Fprintf(buf, "C%.*g,%.*g,%.*g,%.*g,%.*g,%.*g",
					pr, comp.Control[0].X.Dots(c.dpi), pr, comp.Control[0].Y.Dots(c.dpi),
					pr, comp.Control[1].X.Dots(c.dpi), pr, comp.Control[1].Y.Dots(c.dpi),
					pr, comp.Pos.X.Dots(c.dpi), pr, comp.Pos.Y.Dots(c.dpi))
			default:
