...
var want = []string{
	...
	`Scale(1, 2)`,
	`Rotate(0.72)`,
	`/plot/vg/recorder/recorder_test.go:26 Stroke(vg.Path{vg.PathComp{Type:0, Pos:vg.Point{X:3, Y:4}, Control:[]vg.Point(nil), Radius:0, Start:0, Angle:0}})`,
	`/plot/vg/recorder/recorder_test.go:27 Push()`,
	`/plot/vg/recorder/recorder_test.go:28 Pop()`,
	`/plot/vg/recorder/recorder_test.go:29 Translate(3, 4)`,
	`SetLineWidth(100)`,
