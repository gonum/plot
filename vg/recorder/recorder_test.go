...
var want = []string{
	...
	`Scale(1, 2)`,
	`Rotate(0.72)`,
	`github.com/blockstatecom/plot/vg/recorder/recorder_test.go:23 Stroke(vg.Path{vg.PathComp{Type:0, Pos:vg.Point{X:3, Y:4}, Radius:0, Start:0, Angle:0}})`,
	`github.com/blockstatecom/plot/vg/recorder/recorder_test.go:24 Push()`,
	`github.com/blockstatecom/plot/vg/recorder/recorder_test.go:25 Pop()`,
	`github.com/blockstatecom/plot/vg/recorder/recorder_test.go:26 Translate(3, 4)`,
	`SetLineWidth(100)`,
